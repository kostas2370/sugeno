...
class TestSugeno(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mikro = Variable("fuzzy_set", "small", lista1)
        self.megalo = Variable("fuzzy_set", "large", lista2)
    ...
    def test_sugeno_input_variable(self):
        ...
        with self.assertRaises(Exception):
            self.test.add_input_variable(self.input1, Variable("fuzzy_set", "meseo", [20]))
            self.test.add_input_variable(self.input1, Variable("fuzzy_set", "meseo", [(3, 1.2)]))
